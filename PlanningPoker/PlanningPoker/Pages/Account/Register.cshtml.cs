...
namespace PlanningPoker.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<PlanningPokerUser> _userStore;
        ...
        private PlanningPokerUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<PlanningPokerUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(PlanningPokerUser)}'. " +
                    $"Ensure that '{nameof(PlanningPokerUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<PlanningPokerUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<PlanningPokerUser>)_userStore;
        }
    }
}
